...
- Denmark-only registry and public data pack.
- Public provenance notes and a visible Streamlit app.
- Tests that protect the basic public surface.

Creates trust:

- Declared Folketing-only, municipality-level scope.
- Explicit 2026 bridge language.
- Intentionally withheld factors are named instead of hidden.
...
- The 2026 bridge layer can be overread as a normal settled source year.
